...
//결제 옵션을 선택하면, 총 비용을 출력하고 총 비용을 `0` 으로 초기화하세요. (사용자가 총 비용을 확인하고,결제를 완료했다고 가정합니다.
//따라서 다음 사용자를 위해 총 비용을 다시 `0` 으로 초기화 해야합니다.) 프로그램 종료 옵션을 선택하면,
//"프로그램을 종료합니다."라는 메시지를 출력하고 프로그램을 종료하세요. 위의 세 가지 옵션 외에 다른 값을 입력하면, "올바른 옵션을 선택해주세요."라는 메시지를 출력하세요.
